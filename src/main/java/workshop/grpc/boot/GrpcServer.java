...
import workshop.grpc.storage.InMemoryTransactionRepositoryImpl;
...
public class GrpcServer {
    ...
    public void start() throws IOException {
        ...
        TransactionTransport transactionTransport = new TransactionTransport(new InMemoryTransactionRepositoryImpl());
